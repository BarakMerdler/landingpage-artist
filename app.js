function init(){
  ...
  var inner = document.getElementById("layer1");
  var inner1 =  document.getElementById("layer2");
  // Mouse
  var mouse = {
    _x: 0,
    _y: 0,
  ...
  var updateTransformStyle = function(x, y) {
    ...
    var style1 = "rotateX(" + x1 + "deg) rotateY(" + y1 + "deg)";
    ...
    inner1.style.mozTransform = style1;
